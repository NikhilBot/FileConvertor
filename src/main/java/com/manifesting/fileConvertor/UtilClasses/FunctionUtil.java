...
public class FunctionUtil implements CommandLineRunner {
    ...
    public String findAllTrackId(String id) { return tcdaRepository.findById(id).get().getTrackingId();}

    public List<?> findAll(){ return tcdaRepository.findAllTrackingId();}
    public List<Item> getItems ( String id ) {
        return tcdaRepository.findById(id).get().getItems();
    }

    public List<String>  getAllPFTrackingId(){return tcdaRepository.findAllTrackingId();}

    public List<String>  getAllBFTrackingId(){return batchFileRepository.findAllId();}
